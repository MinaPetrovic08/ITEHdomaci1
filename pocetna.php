  ...
  <body>
    ...
    <a class="navbar-brand" href="evaluation.php">E-dnevnik</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="col-md-4">
            <a href="subject.php" class="btn btn-primary px-3 mr-3">Pregled predmeta</a>
        </div>
    ...
    <div class="container">
      ...
      <div class="mt-3 bg-white">
        ...
        <button id="btn-pretraga" class="btn btn-primary px-3 mr-3"> Pretrazi studente</button>
        <input type="text" id="myInput" onkeyup="funkcijaZaPretragu()" placeholder="Pretrazite po id-u" hidden>
        </div>
        </div>
        <div class="table">
          <div style="width:90%">
